...
# Los filtros van dentro de un st.form: así, si el usuario quita varios meses o
# años muy rápido seguidos, Streamlit NO dispara un recálculo pesado por cada
# clic — todos los cambios se acumulan y solo se procesan UNA vez, al apretar
# "Apply filters". Esto es justo lo que evita que el contenedor colapse cuando
# alguien interactúa rápido con los filtros.
