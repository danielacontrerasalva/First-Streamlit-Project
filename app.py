...
<style>
    ...
    /* Igualar alto de tarjetas dentro de una fila de columnas: forzamos height:100%
       en TODOS los divs anidados (Streamlit mete varios wrappers internos sin alto
       definido). Es seguro para la fila de KPIs porque esas 4 columnas ya son
       naturalmente parejas entre sí, así que el 100% no les cambia nada. */
