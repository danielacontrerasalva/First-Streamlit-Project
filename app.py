...
<style>
    ...
    .insight-card b { color: #B8E4C9; }

    /* Slider de la tabla de detalle en verde (independiente del morado del resto de filtros).
       El valor lila viene del primaryColor del tema de Streamlit, que BaseWeb aplica vía
       variable CSS y a varios sub-elementos internos; por eso se sobreescribe la variable
       Y cada elemento explícitamente (track, thumb, texto del valor, ticks). */
    div[data-testid="stSlider"] {
        --primary-color: #B8E4C9 !important;
    }
    ...
    div[data-testid="stSlider"] div[data-baseweb="slider"] div[style*="color"] {
