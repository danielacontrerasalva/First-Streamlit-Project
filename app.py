...
<style>
    ...
    /* Mismo selector universal que sí funcionó para el texto (Feb 2010 / Oct 2012),
       ahora también con background/fill/stroke: la versión anterior exigía estar
       DENTRO de div[data-baseweb="slider"], y si ese atributo no existe tal cual en
       esta versión de Streamlit, la regla nunca hacía match — por eso no pintaba. */
    div[data-testid="stSlider"] * {
        color: #B8E4C9 !important;
        background: #B8E4C9 !important;
        fill: #B8E4C9 !important;
        stroke: #B8E4C9 !important;
